...
const Header = () => {
    ...
    return (
        <nav className="sticky w-full z-20 top-0 start-0 bg-[#18181b]">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    <button type="button" className="text-white bg-amber-600 focus:ring-4 focus:outline-none font-medium rounded-lg text-md px-4 py-2 text-center">Hire me!</button>
